...
namespace Aggregail
{
    ...
    public interface IPendingEvent
    {
        ...
        /// <summary>
        /// Metadata for the event, serialized as JSON.
        /// </summary>
        /// <param name="serializer">The JSON serializer to serialize the event data with.</param>
        /// <returns>JSON of the event metadata, encoded as an UTF-8 string.</returns>
        byte[]? Metadata(IJsonEventSerializer serializer);
    }
}